...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/fabian/spectrum-sensing-salsat/code/samples/gnu_psk_1.wav', 2, samp_rate, 8)
        ...
        self.connect((self.digital_psk_mod_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(0, self.samp_rate*8)
